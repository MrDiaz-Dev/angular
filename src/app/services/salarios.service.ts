...
export class SalariosService {
  ...
  create(newSalarios: SalariosCreateDTO): Observable<SalariosPostRespuesta> {
    const url = this.API_URL + `/salarios`;
  ...
  edit(
    ...
    const url = this.API_URL + `/salarios/${autTarjetaID}`;
  ...
  deleteArray(IDs): Observable<SalariosRespuesta> {
    const url = this.API_URL + `/salarios/delete-array`;
